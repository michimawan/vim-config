...
### With Wget
```
sh -c "$(wget https://raw.githubusercontent.com/michimawan/vim-config/custom/install.sh -O -)"
```

### With Curl
```
sh -c "$(curl -fsSL https://raw.githubusercontent.com/michimawan/vim-config/custom/install.sh)"
```
